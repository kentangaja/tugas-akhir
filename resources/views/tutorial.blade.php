<x-app-layout>
    <div class="min-h-screen bg-white dark:bg-zinc-950 py-16 px-6">
        <div class="max-w-5xl mx-auto">
            
            <div class="text-center mb-16">
                <span class="text-emerald-600 font-bold tracking-widest uppercase text-sm">Getting Started</span>
                <h1 class="text-5xl font-black text-gray-900 dark:text-white mt-4 tracking-tight">How it Works</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
                ...
                <div class="bg-gray-50 dark:bg-zinc-900 p-10 rounded-[3rem] border-2 border-transparent hover:border-emerald-400/30 transition-all group">
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 dark:text-white mb-3">Daftar & Masuk</h3>
                ...
                <div class="bg-gray-50 dark:bg-emerald-900 p-10 rounded-[3rem] border-2 border-transparent hover:border-emerald-400/30 transition-all group">
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 dark:text-white mb-3">Rakit Perangkat</h3>
                ...
                <div class="bg-gray-50 dark:bg-zinc-900 p-10 rounded-[3rem] border-2 border-transparent hover:border-emerald-400/30 transition-all group">
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 dark:text-white mb-3">Upload Program</h3>
                ...
                <div class="bg-gray-50 p-10 rounded-[3rem] border-2 border-transparent hover:border-emerald-400/30 transition-all group relative overflow-hidden">
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 dark:text-white mb-3">Pantau Tanaman</h3>
            ...
            <div class="mt-20 bg-emerald-50 dark:bg-emerald-950/20 p-12 rounded-[4rem] text-center border border-emerald-100 dark:border-emerald-400/30">
                <h2 class="text-2xl font-bold text-emerald-900 dark:text-emerald-400">Butuh bantuan teknis?</h2>
                <p class="text-emerald-700/70 dark:text-emerald-500/70 mt-2 mb-8 italic text-sm">"Semua perubahan besar dimulai dari satu baris kode yang berhasil di-upload."</p>
                <div class="flex flex-wrap justify-center gap-4">
                    <div class="px-6 py-3 bg-white dark:bg-zinc-800 rounded-2xl shadow-sm flex items-center gap-3">
                        <span class="text-xs font-bold text-gray-400 uppercase">Library</span>
                        <span class="font-mono text-sm dark:text-zinc-300 font-bold">ArduinoJson</span>
                    </div>
                    <div class="px-6 py-3 bg-white dark:bg-zinc-800 rounded-2xl shadow-sm flex items-center gap-3">
                        <span class="text-xs font-bold text-gray-400 uppercase">Baudrate</span>
                        <span class="font-mono text-sm dark:text-zinc-300 font-bold">115200</span>
                    </div>
                </div>
            </div>
