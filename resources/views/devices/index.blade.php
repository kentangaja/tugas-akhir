                            ...
                            <div class="relative">
                                ...
                                <div class="flex flex-wrap items-center gap-3">
                                    ...
                                    <form method="POST" action="{{ route('devices.toggle-status', $device->id) }}" class="inline">
                                        @csrf
                                        <button type="submit" class="min-w-[110px] bg-white border-[1px] border-[#e5e7eb] text-[#374151] hover:bg-[#f9fafb] px-5 py-2.5 rounded-2xl text-sm font-semibold transition-all shadow-sm hover:shadow-md cursor-pointer">
                                            @if($device->is_active) 
