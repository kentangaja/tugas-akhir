            ...
            @php
                $members = [
                    [
                        'name'    => 'Andi Pratama',
                        'role'    => 'Founder & CEO',
                        'desc'    => 'Visioner di balik Verte-Maison, berpengalaman di bidang agritech dan smart farming.',
                        'bg'      => 'bg-emerald-100',
                        'linkedin'=> '#',
                        'instagram'=> '#',
                    ],
                    [
                        'name'    => 'Sari Dewi',
                        'role'    => 'Lead Engineer',
                        'desc'    => 'Memimpin pengembangan backend dan infrastruktur IoT platform Verte-Maison.',
                        'bg'      => 'bg-[#d4e9d4]',
                        'linkedin'=> '#',
                        'instagram'=> '#',
                    ],
                    [
                        'name'    => 'Budi Santoso',
                        'role'    => 'UI/UX Designer',
                        'desc'    => 'Merancang pengalaman pengguna yang intuitif dan estetis untuk semua platform.',
                        'bg'      => 'bg-lime-100',
                        'linkedin'=> '#',
                        'instagram'=> '#',
                    ],
                    [
                        'name'    => 'Rina Kusuma',
                        'role'    => 'IoT Specialist',
                        'desc'    => 'Ahli dalam integrasi sensor dan perangkat keras untuk monitoring tanaman.',
                        'bg'      => 'bg-emerald-50',
                        'linkedin'=> '#',
                        'instagram'=> '#',
                    ],
                    [
                        'name'    => 'Deni Wahyu',
                        'role'    => 'Data Analyst',
                        'desc'    => 'Mengolah data sensor menjadi insight yang berguna bagi para petani.',
                        'bg'      => 'bg-green-100',
                        'linkedin'=> '#',
                        'instagram'=> '#',
                    ],
                    [
                        'name'    => 'Maya Putri',
                        'role'    => 'Agri Expert',
                        'desc'    => 'Konsultan pertanian yang memastikan solusi kami relevan di lapangan.',
                        'bg'      => 'bg-teal-100',
                        'linkedin'=> '#',
                        'instagram'=> '#',
                    ],
                    [
                        ...
                        'desc'    => 'Mengembangkan aplikasi mobile agar petani bisa memantau tanaman dari mana saja.',
                        'bg'      => 'bg-emerald-100',
                        'linkedin'=> '#',
                        'instagram'=> '#',
                    ],
                    [
                        ...
                        'desc'    => 'Membangun komunitas petani dan menyebarkan misi Verte-Maison ke seluruh Indonesia.',
                        'bg'      => 'bg-[#d4e9d4]',
                        'linkedin'=> '#',
                        'instagram'=> '#',
                    ],
